...
//    }
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception{
        ...
        httpSecurity
                ...
                .antMatchers( "/authentication/login","/authentication/registration", "/error", "/product/**", "/img/**", "/product/info/{id}", "product/search", "/orders", "/static/**", "/order", "/favicon.ico").permitAll()
...
//        authenticationManagerBuilder.authenticationProvider(authenticationProvider);
    ...
    {
        web.ignoring().antMatchers("/js/**", "/css/**", "/fonts/**", "/img/**", "/resources/**", "/static/**", "/uploads/**");
    }
